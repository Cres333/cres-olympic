...
execute if data storage main {mode:multi} run scoreboard players set @r[limit=1,team=r,scores={_ID=0}] _ID 1
execute if data storage main {mode:multi} run scoreboard players set @r[limit=1,team=b,scores={_ID=0}] _ID 2
execute if data storage main {mode:multi} run scoreboard players set @r[limit=1,team=b,scores={_ID=0}] _ID 2
execute if data storage main {mode:multi} run scoreboard players set @r[limit=1,team=y,scores={_ID=0}] _ID 3
execute if data storage main {mode:multi} run scoreboard players set @r[limit=1,team=y,scores={_ID=0}] _ID 3
execute if data storage main {mode:multi} run scoreboard players set @r[limit=1,team=g,scores={_ID=0}] _ID 4
execute if data storage main {mode:multi} run scoreboard players set @r[limit=1,team=g,scores={_ID=0}] _ID 4
