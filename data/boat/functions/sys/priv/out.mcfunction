...
execute if entity @e[tag=remove] run summon boat ~ ~0.5 ~ {Invulnerable:true,Rotation:[-180F,0F],Passengers:[{id:"minecraft:armor_stand",NoGravity:true,Marker:true,Invisible:true,Tags:["rider"]}]}
kill @e[tag=remove]
