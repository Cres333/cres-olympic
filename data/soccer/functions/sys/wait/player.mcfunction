...
execute if entity @p[scores={_HAS=1}] as @e[tag=ball] at @s if block ~ 38 ~ white_stained_glass run scoreboard players set $cornor _ 1
execute if entity @p[scores={_HAS=1}] as @e[tag=ball,predicate=!soccer:black-goal] at @s if block ~ 38 ~ red_stained_glass run scoreboard players set $cornor _ 2
execute if entity @p[scores={_HAS=1}] as @e[tag=ball,predicate=!soccer:white-goal] at @s if block ~ 38 ~ orange_stained_glass run scoreboard players set $cornor _ 3
...
execute as @p[scores={_HAS=1}] at @s positioned ^ ^ ^2 if block ~ 32 ~ air run tp @e[tag=ground] ~ 30.7 ~
