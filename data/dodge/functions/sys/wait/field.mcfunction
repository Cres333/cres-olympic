...
## いなければフィールド開放
execute unless block 1058 33 -1347 red_wool if score $remainR _ matches 0 run fill 1037 33 -1368 1058 33 -1347 white_wool
execute unless block 1060 33 -1345 blue_wool if score $remainB _ matches 0 run fill 1081 33 -1324 1060 33 -1345 white_wool
execute unless block 1058 33 -1345 yellow_wool if score $remainY _ matches 0 run fill 1037 33 -1324 1058 33 -1345 white_wool
execute unless block 1060 33 -1347 green_wool if score $remainG _ matches 0 run fill 1081 33 -1368 1060 33 -1347 white_wool
