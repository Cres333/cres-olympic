...
## チームの存在チェック
execute if entity @p[team=r,predicate=util:play] run scoreboard players add $remainR _ 1
execute if entity @p[team=b,predicate=util:play] run scoreboard players add $remainB _ 1
execute if entity @p[team=y,predicate=util:play] run scoreboard players add $remainY _ 1
execute if entity @p[team=g,predicate=util:play] run scoreboard players add $remainG _ 1
