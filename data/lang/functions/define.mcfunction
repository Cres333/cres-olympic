...
data modify storage lang core.book.play.draft set value '{"text":"下見モードを開始","clickEvent":{"action": "run_command","value": "/function core:play/draft"},"hoverEvent":{"action":"show_text","value":"クリックで実行"}}'
...
data modify storage lang clay.desc prepend value '{"translate":"%s","with":["奥から飛んでくるブタを撃ち抜く競技です。"]}'
...
data modify storage lang clay.desc prepend value '{"translate":"%s","with":["５秒ごとに連続で１０匹のブタが飛んできます。"]}'
data modify storage lang clay.desc prepend value '{"translate":"%s","with":["より多くのブタをクロスボウで撃ち抜いてください。"]}'
