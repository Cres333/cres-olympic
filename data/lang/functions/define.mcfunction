...
data modify storage lang soccer.goal.ry set value '{"translate":"%s - %s","with":[{"color":"red","score":{"name":"$w","objective":"_"}},{"color":"#E997F4","score":{"name":"$b","objective":"_"}}]}'
...
data modify storage lang soccer.goal.by set value '{"translate":"%s - %s","with":[{"color":"blue","score":{"name":"$w","objective":"_"}},{"color":"#E997F4","score":{"name":"$b","objective":"_"}}]}'
...
data modify storage lang soccer.goal.yg set value '{"translate":"%s - %s","with":[{"color":"#E997F4","score":{"name":"$w","objective":"_"}},{"color":"green","score":{"name":"$b","objective":"_"}}]}'
