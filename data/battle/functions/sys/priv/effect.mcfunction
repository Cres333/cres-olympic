...
execute if score $effect _ matches 1 run title @a actionbar {"color":"yellow","text":"GOOD: 防御強化エフェクト発生"}
execute if score $effect _ matches 2 run title @a actionbar {"color":"yellow","text":"GOOD: 攻撃強化エフェクト発生"}
execute if score $effect _ matches 3 run title @a actionbar {"color":"yellow","text":"GOOD: 体力回復エフェクト発生"}
execute if score $effect _ matches 4 run title @a actionbar {"color":"yellow","text":"GOOD: 透明化エフェクト発生"}
execute if score $effect _ matches 5 run title @a actionbar {"color":"black","text":"BAD: 速度低下エフェクト発生"}
execute if score $effect _ matches 6 run title @a actionbar {"color":"black","text":"BAD: 盲目エフェクト発生"}
execute if score $effect _ matches 7 run title @a actionbar {"color":"black","text":"BAD: 毒エフェクト発生"}
execute if score $effect _ matches 8 run title @a actionbar {"color":"black","text":"BAD: 速度上昇エフェクト発生"}
