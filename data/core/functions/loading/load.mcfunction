...
execute if score $value _LOADING < $max _LOADING run schedule function core:loading/load 2t
execute unless score $value _LOADING < $max _LOADING run function core:loading/end
