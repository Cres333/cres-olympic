...
summon villager ~1 ~ ~1 {NoAI:true,Tags:["dummy"],Team:"b",Silent:true,Offers:{},VillagerData:{type:"snow"}}
summon villager ~1 ~ ~2 {NoAI:true,Tags:["dummy"],Team:"b",Silent:true,Offers:{},VillagerData:{type:"snow"}}
summon villager ~1 ~ ~3 {NoAI:true,Tags:["dummy"],Team:"b",Silent:true,Offers:{},VillagerData:{type:"snow"}}
summon villager ~1 ~ ~4 {NoAI:true,Tags:["dummy"],Team:"b",Silent:true,Offers:{},VillagerData:{type:"snow"}}
...
summon villager ~3 ~ ~1 {NoAI:true,Tags:["dummy"],Team:"g",Silent:true,Offers:{},VillagerData:{type:"desert"}}
summon villager ~3 ~ ~2 {NoAI:true,Tags:["dummy"],Team:"g",Silent:true,Offers:{},VillagerData:{type:"desert"}}
summon villager ~3 ~ ~3 {NoAI:true,Tags:["dummy"],Team:"g",Silent:true,Offers:{},VillagerData:{type:"desert"}}
summon villager ~3 ~ ~4 {NoAI:true,Tags:["dummy"],Team:"g",Silent:true,Offers:{},VillagerData:{type:"desert"}}
