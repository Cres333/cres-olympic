...
## 個人戦の場合
execute if data storage main {mode:single} run give @s written_book{title:"結果",author:"",pages:['{"interpret":true,"storage":"lang","nbt":"core.book.single"}','{"interpret":true,"storage":"lang","nbt":"core.book.pages[0]"}','{"interpret":true,"storage":"lang","nbt":"core.book.pages[1]"}']}
