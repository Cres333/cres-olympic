...
execute as @p[scores={_R=4},predicate=util:play] at @s if block ~ 32 ~ yellow_concrete run scoreboard players set $4 _ 1
execute as @p[scores={_B=4},predicate=util:play] at @s if block ~ 32 ~ yellow_concrete run scoreboard players set $4 _ 2
execute as @p[scores={_Y=4},predicate=util:play] at @s if block ~ 32 ~ yellow_concrete run scoreboard players set $4 _ 3
execute as @p[scores={_G=4},predicate=util:play] at @s if block ~ 32 ~ yellow_concrete run scoreboard players set $4 _ 4
