...
## 5秒ごとに繰り返す
execute if score $summon _ matches ..9 run schedule function clay:sys/priv/start 5s

## 10回やったら終わる
execute unless score $summon _ matches ..9 run schedule function clay:sys/priv/stop 5s
