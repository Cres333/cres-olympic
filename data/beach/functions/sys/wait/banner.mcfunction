...
execute if score $round _ matches 1 if score $set _ matches 6.. run scoreboard players set $end _ 1
execute if score $round _ matches 2 if score $set _ matches 4.. run scoreboard players set $end _ 1
