...
execute if score $most SCORE = @p[team=y,predicate=util:join] SCORE run scoreboard players set @a[team=y,predicate=util:join] _MEDAL 1
execute if score $most SCORE = @p[team=g,predicate=util:join] SCORE run scoreboard players set @a[team=g,predicate=util:join] _MEDAL 1
### チームに金メダル配分
...
execute if score $most SCORE = @p[team=y,predicate=util:join] SCORE run scoreboard players set @a[team=y,predicate=util:join] _MEDAL 2
execute if score $most SCORE = @p[team=g,predicate=util:join] SCORE run scoreboard players set @a[team=g,predicate=util:join] _MEDAL 2
### チームに金メダル配分
...
execute if score $most SCORE = @p[team=y,predicate=util:join] SCORE run scoreboard players set @a[team=y,predicate=util:join] _MEDAL 3
execute if score $most SCORE = @p[team=g,predicate=util:join] SCORE run scoreboard players set @a[team=g,predicate=util:join] _MEDAL 3
### チームに金メダル配分
