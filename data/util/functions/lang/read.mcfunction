...
# ゲーム説明
execute if score $desc _ matches 15 run tellraw @a {"interpret":true,"nbt":"temp.desc[14]","storage":"lang"}
execute if score $desc _ matches 14 run tellraw @a {"interpret":true,"nbt":"temp.desc[13]","storage":"lang"}
execute if score $desc _ matches 13 run tellraw @a {"interpret":true,"nbt":"temp.desc[12]","storage":"lang"}
execute if score $desc _ matches 12 run tellraw @a {"interpret":true,"nbt":"temp.desc[11]","storage":"lang"}
execute if score $desc _ matches 11 run tellraw @a {"interpret":true,"nbt":"temp.desc[10]","storage":"lang"}
execute if score $desc _ matches 10 run tellraw @a {"interpret":true,"nbt":"temp.desc[9]","storage":"lang"}
