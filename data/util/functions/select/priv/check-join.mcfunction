...
execute if score $team _TICKET matches 1 run scoreboard players set @a[team=r,predicate=!util:has-ticket,gamemode=!spectator] _TICKET 1
execute if score $team _TICKET matches 2 run scoreboard players set @a[team=b,predicate=!util:has-ticket,gamemode=!spectator] _TICKET 1
execute if score $team _TICKET matches 3 run scoreboard players set @a[team=y,predicate=!util:has-ticket,gamemode=!spectator] _TICKET 1
execute if score $team _TICKET matches 4 run scoreboard players set @a[team=g,predicate=!util:has-ticket,gamemode=!spectator] _TICKET 1
