...
tellraw @a[team=!] {"color":"#FFF9C1","translate":"[システム] 次の競技に参加する方は、参加券を捨ててください。"}
tellraw @a[team=!] {"color":"#FFF9C1","translate":"[システム] 参加可能人数は、%s 人です。","with":[{"interpret":true,"nbt":"join","storage":"main"}]}
